				...
				<?php 
					...
					while($row1 = mysqli_fetch_assoc($query)) { 
        				...
        				if ($exam_time > $current_time) { ?> 
							<td>
								<a href="/fyp/index2.php?id=<?=$row['course_code']?>"><i class="fa fa-check" style="font-size:24px"></i></a>
							</td>
						<?php } else { ?>
							<td>
								<a href="/fyp/index3.php?id=<?=$row['course_code']?>"><i class="fa fa-pie-chart" style="font-size:24px"></i></a>
							</td>
						<?php } ?>
			</tr>
			<?php } $count++; } ?>
